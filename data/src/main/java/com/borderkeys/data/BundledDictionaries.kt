...
object BundledDictionaries {
    ...
    val ALL: List<Entry> = listOf(
        Entry("ro-RO", "Romanian", "dict/ro_RO.bkd", "ro_RO.bkd", 107_395),
        Entry("en-US", "English", "dict/en_US.bkd", "en_US.bkd", 140_466),
        Entry("es-ES", "Spanish", "dict/es_ES.bkd", "es_ES.bkd", 100_773),
        Entry("fr-FR", "French", "dict/fr_FR.bkd", "fr_FR.bkd", 102_284),
        Entry("de-DE", "German", "dict/de_DE.bkd", "de_DE.bkd", 103_630),
        Entry("it-IT", "Italian", "dict/it_IT.bkd", "it_IT.bkd", 102_928),
    )
