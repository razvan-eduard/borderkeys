...
Current baseline: **71.9% first place, 81.2% top three, mean rank 1.43**, 32 cases. The mean
moved from 1.39 when `kDeleteCost` rose to 1.6; first and top-three did not, and that is what
set the ceiling on the sweep -- 1.7 buys more unknown-word survival and costs 3.1 points of
first place.
...
Current baseline: **85.5% left alone**, 200 cases, up from 66.0%.
