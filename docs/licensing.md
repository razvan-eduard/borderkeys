...
**No dictionaries, no models, no fonts, no images, and no launcher icon.** The word packs are not
in the APK by design — see 2.2. The absence of an icon is a gap in the product, not a licence
question, and is recorded here so it is not mistaken for one.
